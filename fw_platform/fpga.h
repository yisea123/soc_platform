...
/* memory map (offset): */
#define FPGA_REG_ADC_COMPARE_OFFSET		0x0000
#define FPGA_REG_ADC_COMPARE_1			(FPGA_REG_ADC_COMPARE_OFFSET+0x0000)
#define FPGA_REG_ADC_COMPARE_2			(FPGA_REG_ADC_COMPARE_OFFSET+0x0004)
#define FPGA_REG_ADC_COMPARE_3			(FPGA_REG_ADC_COMPARE_OFFSET+0x0008)

#define FPGA_REG_ADC_THRESHOLD_OFFSET		0x0040
#define FPGA_REG_ADC_THRESHOLD_1		(FPGA_REG_ADC_THRESHOLD_OFFSET+0x0000)

#define FPGA_REG_ADC_AVERAGE_OFFSET		0x00C0
#define FPGA_REG_ADC_AVERAGE_1			(FPGA_REG_ADC_AVERAGE_OFFSET+0x0000)

#define FPGA_REG_ADC_INT_OFFSET			0x0140
#define FPGA_REG_ADC_INT_ENABLE_1		(FPGA_REG_ADC_INT_OFFSET+0x0000)
#define FPGA_REG_ADC_INT_ENABLE_2		(FPGA_REG_ADC_INT_OFFSET+0x0004)
#define FPGA_REG_ADC_INT_ENABLE_3		(FPGA_REG_ADC_INT_OFFSET+0x0008)
#define FPGA_REG_ADC_INT_CLEAR_1		(FPGA_REG_ADC_INT_OFFSET+0x000c)
#define FPGA_REG_ADC_INT_CLEAR_2		(FPGA_REG_ADC_INT_OFFSET+0x0010)
#define FPGA_REG_ADC_INT_CLEAR_3		(FPGA_REG_ADC_INT_OFFSET+0x0014)
#define FPGA_REG_ADC_INT_STATUS_1		(FPGA_REG_ADC_INT_OFFSET+0x0018)
#define FPGA_REG_ADC_INT_STATUS_2		(FPGA_REG_ADC_INT_OFFSET+0x001c)
#define FPGA_REG_ADC_INT_STATUS_3		(FPGA_REG_ADC_INT_OFFSET+0x0020)

#define FPGA_REG_ADC_INT_MODE_1			(FPGA_REG_ADC_INT_OFFSET+0x0024)
#define FPGA_REG_ADC_INT_MODE_2			(FPGA_REG_ADC_INT_OFFSET+0x0028)
#define FPGA_REG_ADC_INT_MODE_3			(FPGA_REG_ADC_INT_OFFSET+0x002c)
#define FPGA_REG_ADC_INT_MODE_4			(FPGA_REG_ADC_INT_OFFSET+0x0030)
#define FPGA_REG_ADC_INT_MODE_5			(FPGA_REG_ADC_INT_OFFSET+0x0034)
#define FPGA_REG_ADC_INT_MODE_6			(FPGA_REG_ADC_INT_OFFSET+0x0038)
