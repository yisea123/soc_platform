#ifndef __MECHLIB2_H__
#define __MECHLIB2_H__
...
#define MECHUINT_NAME_LEN 32  // max. length of name defined in dts(device tree source). 
//#define MAX_SPEED_NUMS		32
//#define MAX_SPEED_NUMS		8
...
#define MOTOR_SEN_LEAVE	    1	// leave the sensors.
#define MOTOR_SEN_ARRIVE	2	// arrived the sensors.
...
typedef struct{
	...
	unsigned int pps_ref_value;
	unsigned int pps_drv_value;
}
sen_config_t;
