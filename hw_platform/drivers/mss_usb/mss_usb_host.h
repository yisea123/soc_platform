...
/*
 ...
 implemented by the USBH-Class driver as part of mss_usbh_class_cb_t type, which
 are called by the USBH driver. The USBH driver uses these values to infer
...
/***************************************************************************//**
 Data structures internally by USBH driver
*/
...
/***************************************************************************//**
  ...
  this parameter are as mentioned in the table below.
    ...
    Bulk                        HS                0,2,4,8,16,32,64…32768 microframes
                                                  Note:Value 0 disables the
                                                  NAK Timeout detection on Bulk EP
