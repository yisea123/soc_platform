...
__align(4) uint8_t get_max_lun_response[] = {0x00u};
#endif
/*
...
#elif defined(__CC_ARM)
__align(4) uint8_t format_capacity_list[12] = {0};
#endif
/*
...
#elif defined(__CC_ARM)
__align(4) mss_usbd_msc_lun_capacity_t lun_capacity[4] = {{0},{0},{0},{0}};
#endif
/*
...
#elif defined(__CC_ARM)
__align(4) uint8_t mode_sense_response[4] = {0x03u, 0x00u, 0x00u, 0x00u};
#endif
/*
...
#elif defined(__CC_ARM)
__align(4) mss_usbd_msc_scsi_sense_resp_t g_sense_response = {0xF0,0,0,{0},0x0b,{0},0,{0}};
#endif
 /*
...
#elif defined(__CC_ARM)
__align(4) mss_usb_msc_cbw_t g_bot_cbw;
#endif
/*
...
mss_usbd_msc_csw_t g_current_command_csw = {USB_MSC_BOT_CSW_SIGNATURE,
                                            ...
                                            SCSI_COMMAND_PASS};
#elif defined(__CC_ARM)
__align(4) mss_usbd_msc_csw_t g_current_command_csw = {USB_MSC_BOT_CSW_SIGNATURE,
                                            0,
                                            0,
                                            SCSI_COMMAND_PASS};
